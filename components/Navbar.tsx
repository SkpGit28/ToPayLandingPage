...
<Link to="/" className="flex items-center gap-2 cursor-pointer group relative z-50 w-[220px]">
  ...
  {/* <span className="font-display font-bold text-xl text-text-main tracking-tight">ToPay</span> */}
          ...
          <div className="hidden md:flex gap-12 items-center absolute left-1/2 -translate-x-1/2">
           <Link to="/" className="text-sm font-medium text-text-main hover:text-brand-primary transition-colors">Home</Link>
            {/* Mega Menu Trigger */}
            <div 
              className="relative"
            ...
            <Link  to="/company" className="text-sm font-medium text-text-main hover:text-brand-primary transition-colors">Company</Link>
            <Link to="/contact" className="text-sm font-medium text-text-main hover:text-brand-primary transition-colors">Contact Us</Link>
          </div>
