...
const CTAButton: React.FC<CTAButtonProps> = ({ mode, size = 'small', className = '', customText, 'aria-label': ariaLabel }) => {
  ...
  const href = isEnterprise ? 'https://customer.topay.live/' : 'https://play.google.com/store/apps/details?id=com.topay.android&hl=en_IN';
  ...
  return (
    <a
      ...
      className={`${buttonColorClass} text-white rounded-full transition-all transform active:translate-y-0 active:scale-95 ${sizeClasses} ${className} inline-flex items-center justify-center`}
