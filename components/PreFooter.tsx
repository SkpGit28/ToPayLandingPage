    ...
    <section className="py-32 px-4 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href={isEnterprise ? "#" : "https://play.google.com/store/apps/details?id=com.topay.android&hl=en_IN"}
            target="_blank"
            rel="noopener noreferrer"
            className={`px-8 py-4 rounded-full text-white font-bold text-lg shadow-xl hover:shadow-2xl transition-transform hover:-translate-y-1 active:translate-y-0 inline-flex items-center justify-center
